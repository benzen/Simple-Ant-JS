define ()->
  ...
  drawAnt = (ctx, x, y)->
    [color,radius,c1y,c2y,c3x]=['white', 2, y+radius, y+2*radius+1, y3*radius-3]
    drawCercle ctx, color, x, cy1, radius
    drawCercle ctx, color, x, cy2, radius-1
    drawCercle ctx, color, x, cy3, radius
